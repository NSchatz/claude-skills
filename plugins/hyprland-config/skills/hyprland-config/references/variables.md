...
- Variable types (int, bool, float, color, vec2, MOD, str, gradient, font_weight)
- General (gaps, borders, layout, resize)
- Decoration (rounding, blur, shadow, glow, opacity)
- Animations (enabled toggle)
- Input (keyboard, mouse, touchpad, touchdevice, tablet)
- Per-device input config
- Gestures
- Group / Groupbar
- Misc (VRR, DPMS, splash, etc.)
- Layout (border/resize defaults)
- Binds (scroll delay, focus behavior)
- XWayland
- OpenGL
- Render
- Cursor
